        ...
        <ul class="navbar-item flex-row ms-lg-auto ms-0">
            ...
            <li class="nav-item dropdown language-dropdown">
                ...
                <div class="dropdown-menu position-absolute" aria-labelledby="language-dropdown">
                    <a class="dropdown-item d-flex" href="{{ route('language', ['locale' => 'ar']) }}">
                        <img src="{{ Vite::asset('resources/images/1x1/us.svg') }}" class="flag-width" alt="sa-flag">
                        <span class="align-self-center">&nbsp;العربية</span>
                    </a>
                    <a class="dropdown-item d-flex" href="{{ route('language', ['locale' => 'en']) }}">
                        <img src="{{ Vite::asset('resources/images/1x1/us.svg') }}" class="flag-width" alt="us-flag">
